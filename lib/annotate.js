...
function do_annotation(obj) {
	...
	$('<span class="time"></span>').prependTo(div).append(div.attr('smil:begin').substring(0,10));
	
	e = [];
	$('.annotations > div').each(function() { 
		console.log($.media.convertTimestamp($(this).attr('smil:begin')) + ">" +  $.media.convertTimestamp(div.attr('smil:begin')));
